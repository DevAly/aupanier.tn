@if (isset($data['repeater_data']['title_']))
                ...
                <div class="banner-content-wrapper">
                    <div class="global-slick-init dot-style-one dot-color-two banner-dots dot-absolute"
                        ...
                        @foreach($data['repeater_data']['title_'] as $key => $value)
                            @php
                                $title = \App\Helpers\SanitizeInput::esc_html(changeInformation($value)) ?? '';
                            ...
                            <div class="banner-image">
                                ...
                                <div class="banner-image-content">
                                    ...
                                    <div class="btn-wrapper">
                                        <a href="{{changeInformation($button_url)}}" class="cmn-btn cmn-btn-bg-2 radius-0 mt-4 mt-lg-5"> {{changeInformation($button_text)}} </a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
