...
Route::middleware([
    ...
    Route::middleware(['package_expire', 'website_creation_in_progress'])->controller(\App\Http\Controllers\Tenant\Frontend\TenantFrontendController::class)->group(function () {
    ...
    /* tenant admin login */
    Route::middleware(['package_expire', 'website_creation_in_progress'])->controller(\App\Http\Controllers\Landlord\Admin\Auth\AdminLoginController::class)->prefix('admin')->group(function (){
...
Route::middleware([
    ...
    Route::middleware(['maintenance_mode','package_expire', 'website_creation_in_progress'])->controller(\App\Http\Controllers\Tenant\Frontend\TenantFrontendController::class)->name('tenant.')->group(function () {
    ...
    Route::controller(UserDashboardController::class)->prefix('user-home')->middleware(['tenantUserMailVerify','package_expire','auth', 'website_creation_in_progress'])->name('tenant.')->group(function(){
    ...
    Route::get('/website-creation-in-progress', 'App\Http\Controllers\Tenant\Frontend\TenantFrontendController@website_creation_in_progress_redirection')->name('tenant.frontend.package.creationInProgress');

    Route::middleware(['maintenance_mode','package_expire', 'website_creation_in_progress'])->controller(\App\Http\Controllers\Tenant\Frontend\TenantFrontendController::class)->group(function () {
        //Newsletter
