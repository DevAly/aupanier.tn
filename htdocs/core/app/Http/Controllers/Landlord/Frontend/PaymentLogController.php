...
class PaymentLogController extends Controller
{
    ...
    public function order_payment_form(Request $request)
    {
        ...
        if ($request->selected_payment_gateway === 'manual_payment')
        {
            ...
            //Auto enable zero plans
            app('App\Http\Controllers\Landlord\Admin\OrderManageController')->payment_logs_approve(request(), $this->payment_details['id']);
    ...
    public function common_charge_customer_data($payment_gateway_name)
    {
        ...
        return [
            ...
            'ipn_url' => route('landlord.frontend.' . strtolower($payment_gateway_name) . '.ipn', ['id' => $this->payment_details['id']]),
    ...
    public function paymee_ipn()
    {

        $paymee = PaymentGatewayCredential::get_paymee_credential();
        $payment_data = $paymee->ipn_response([
