...
//            case "queue":
    ...
    public function facebook_pixel_settings()
    {
        return view(self::BASE_PATH . 'facebook-pixel-settings');
    }

    public function update_facebook_pixel_settings(Request $request)
    {
        $nonlang_fields = [
            'is_facebook_pixel_enabled' => 'nullable|string',
