...
<body>
    <!-- 404 Area Starts -->
    <section class="single-page-area padding-top-100 padding-bottom-50" style="padding:100px 0 50px 0">
        <div class="container container-one">
            <div class="single-page-wrapper center-text"  style="text-align: center !important;">
                <div class="single-page">
                    ...
                    <div class="single-page-contents mt-4 mt-lg-5">
                        <h2 class="single-page-contents-title fw-600 mb-5"> {{__('Sorry! We can\'t find that page')}} </h2>
                        <div class="btn-wrapper">
                            <a href="{{url('/')}}" class="cmn-btn cmn-btn-bg-2 radius-0 mt-4" style="background-color: black;color:white; padding :1em;border-radius:10px;margin:4em;text-decoration: none!important;"> {{__('Back to Home')}} </a>
                        </div>
                    </div>
                </div>
            </div>
