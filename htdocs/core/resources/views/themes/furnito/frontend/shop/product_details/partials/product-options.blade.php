<div class="single-shop-details-wrapper">
    ...
    <div class="price-update-through mt-4">
        <h3 class="ff-rubik flash-prices teess"
        ...
        <span
            class="fs-22 flash-old-prices"> {{$deleted_price != null && $sale_price<$deleted_price  ? amount_with_currency_symbol($deleted_price) : ''}} </span>
    </div>
