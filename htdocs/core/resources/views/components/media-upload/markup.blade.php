  ...
  $(document).ready(function() {
    ...
    function handleMediaUploadModal() {
      ...
      if ($mediaUploadModal.hasClass('show')) {
        ...
        // Add other code here to revert other changes if necessary
      } else {
        // Revert changes when the class is not present
        $('body').css('overflow', 'auto'); // Show scroll bars
        // Add other code here to revert other changes if necessary
      }
    }

    // Attach a listener to the class change
    $('#media_upload_modal').on('transitionend', handleMediaUploadModal);
  });
</script>
<script>
  $(document).ready(function() {
    // Attach a listener to the button click
    $('.media_upload_form_btn').click(function() {
      $('body').css('overflow', 'hidden'); // Hide scroll bars
    });

    // Attach a listener to the close button click
