...
@if($user->code_tva)        <li><strong>{{__('TVA Code :').' '}}</strong> {{$user->code_tva}}</li> @endif
@if($user->matricule_fiscal)<li><strong>{{__('TIN :').' '}}</strong> {{$user->matricule_fiscal}}</li> @endif
                        </ul>
                    </div>
                    <div class="col-lg-9">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                if (!empty($payment))
                                                {
                                                    $start_date = date('d F Y',strtotime($payment->start_date));
                                                    $end_date = date('d F sY',strtotime($payment->expire_date));;
                                                }
                                            @endphp
