...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/landlord/frontend/css/common.css')}}?version={{time()}}">
    ...
    <link rel="stylesheet" href="{{global_asset('assets/landlord/frontend/css/custom-style.css')}}?version={{time()}}">
