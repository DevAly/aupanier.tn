                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="input-group mb-3" style ="margin-top:2em;">
                                                ...
                                                @endphp
                                                <input type="text" class="form-control custom_subdomain"  name="subdomain" placeholder="{{__('Subdomain')}}" aria-label="Subdomain" aria-describedby="basic-addon2" autocomplete="off" value="">
