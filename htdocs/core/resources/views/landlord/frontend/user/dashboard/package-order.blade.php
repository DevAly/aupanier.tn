                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-wrapper">
                                <a href="{{route(route_prefix().'frontend.order.confirm',$data->package_id)}}?domain={{$data->tenant_id}}" class="cmn-btn btn-success cmn-btn-small text-white" target="_blank">{{__('Renew Now')}}</a>
                            </div>
                        </td>
                    </tr>
                @endforeach
