            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="btn-wrapper mt-5">
                        <a href="{{route('landlord.user.home')}}" class="cmn-btn cmn-btn-bg-1 ">{{__('Dashboard')}}</a>

                        @if(!empty($site_domain))
                            <a href="{{tenant_url_with_protocol($site_domain->domain)}}?aupanier_login_token={{ getLoginToken($site_domain->tenant_id) }}" class="cmn-btn cmn-btn-bg-4" target="_blank">{{__('Open Shop')}} <i class="store-icon las la-store-alt"></i></a>
                        @endif
                    </div>
                </div>
                <div class="col-lg-4">
