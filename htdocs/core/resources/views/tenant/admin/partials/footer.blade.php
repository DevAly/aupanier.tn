...
<script>
    const aupanier_centrale_domain = '{{ current(config('tenancy.central_domains')) }}';
    const aupanier_routes = {
        aupanier_admin_ai_describe: '{{ route('tenant.admin.describe')}}',
    };

</script>
<script src="{{global_asset('assets/landlord/admin/js/custom.js')}}?version={{ time() }}"></script>
