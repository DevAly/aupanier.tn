<?php //3c17342b467b979155446be19b98ee08
/** @noinspection all */

namespace Anand\LaravelPaytmWallet\Facades {
    
    /**
     * @see \Anand\LaravelPaytmWallet\Contracts\Factory::driver
     * @method static \Anand\LaravelPaytmWallet\Contracts\Provider driver($do = null)
     */
    class PaytmWallet {}
}
...
namespace App\Facades {
    ...
    /**
     * @see \App\Helpers\LanguageHelper::user_lang_slug
     * @method static mixed|null user_lang_slug()
     * @see \App\Helpers\LanguageHelper::default
     * @method static null default()
     * @see \App\Helpers\LanguageHelper::default_slug
     * @method static \Illuminate\Config\Repository|\Illuminate\Contracts\Foundation\Application|mixed|null default_slug()
     * @see \App\Helpers\LanguageHelper::default_dir
     * @method static string default_dir()
     * @see \App\Helpers\LanguageHelper::user_lang
     * @method static null user_lang()
     * @see \App\Helpers\LanguageHelper::user_lang_dir
     * @method static string user_lang_dir()
     * @see \App\Helpers\LanguageHelper::all_languages
     * @method static \Illuminate\Database\Eloquent\Collection|null all_languages(int $type = null)
     */
    class GlobalLanguage {}
    
    /**
     * @see \App\Helpers\SidebarMenuHelper::render_sidebar_menus
     * @method static string render_sidebar_menus()
     * @see \App\Helpers\SidebarMenuHelper::render_tenant_sidebar_menus
     * @method static string render_tenant_sidebar_menus()
     */
    class LandlordAdminMenu {}
}
...
namespace Artesaos\SEOTools\Facades {
     ...
     * @method static \Artesaos\SEOTools\Contracts\OpenGraph addAudio(string $source = null, array $attributes = [])
     ...
     * @method static \Artesaos\SEOTools\Contracts\OpenGraph addVideo(string $source = null, array $attributes = [])
     ...
     * @method static \Artesaos\SEOTools\Contracts\MetaTags addMeta(array|string $meta, string $value = null, string $name = 'name')
...
namespace Barryvdh\Debugbar {
     ...
     * @method static null|void addException(\Exception $e)
...
namespace Spatie\Translatable\Facades {
    ...
    /**
     * @see \Spatie\Translatable\Translatable::fallback
     * @method static \Spatie\Translatable\Translatable fallback(null|string $fallbackLocale = null, bool|null $fallbackAny = false, $missingKeyCallback = null)
     */
    class Translatable {}
}
...
namespace Stancl\Tenancy\Facades {
     ...
     * @see \Illuminate\Support\Traits\Macroable::macro
     * @method static void macro(string $name, callable|object $macro)
     * @see \Stancl\Tenancy\Tenancy::query
     * @method static \Illuminate\Database\Eloquent\Builder query()
     * @see \Stancl\Tenancy\Tenancy::runForMultiple
     * @method static void runForMultiple(null|\Stancl\Tenancy\Contracts\Tenant[]|string[]|\Traversable $tenants, callable $callback)
     * @see \Illuminate\Support\Traits\Macroable::mixin
     * @method static void mixin(object $mixin, bool $replace = true)
     * @see \Stancl\Tenancy\Tenancy::central
     * @method static mixed central(callable $callback)
     * @see \Illuminate\Support\Traits\Macroable::hasMacro
     * @method static bool hasMacro(string $name)
     * @see \Stancl\Tenancy\Tenancy::find
     * @method static null|\Stancl\Tenancy\Contracts\Tenant find($id)
     * @see \Stancl\Tenancy\Tenancy::end
     * @method static void end()
     * @see \Stancl\Tenancy\Tenancy::model
     * @method static \Illuminate\Database\Eloquent\Model|\Stancl\Tenancy\Contracts\Tenant model()
     * @see \Stancl\Tenancy\Tenancy::initialize
     * @method static void initialize(int|\Stancl\Tenancy\Contracts\Tenant|string $tenant)
     * @see \Illuminate\Support\Traits\Macroable::flushMacros
     * @method static void flushMacros()
     * @see \Stancl\Tenancy\Tenancy::getBootstrappers
     * @method static \Stancl\Tenancy\Contracts\TenancyBootstrapper[] getBootstrappers()
     * @see \Stancl\Tenancy\Tenancy::impersonate
     * @method static \Stancl\Tenancy\Database\Models\ImpersonationToken impersonate(\Stancl\Tenancy\Contracts\Tenant $tenant, string $userId, string $redirectUrl, string $authGuard = null)
     */
    class Tenancy {}
}
...
namespace Xgenious\Paymentgateway\Facades {
     ...
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::squareup
     * @method static \Xgenious\Paymentgateway\Base\Gateways\SquarePay squareup()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::billplz
     * @method static \Xgenious\Paymentgateway\Base\Gateways\BillPlzPay billplz()
     ...
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::zitopay
     * @method static \Xgenious\Paymentgateway\Base\Gateways\ZitoPay zitopay()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::setApplicationId
     * @method static void setApplicationId()
     ...
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::setLocationId
     * @method static void setLocationId()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::cinetpay
     * @method static \Xgenious\Paymentgateway\Base\Gateways\CinetPay cinetpay()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::wrapped_id
     * @method static string wrapped_id($id)
     ...
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::paytabs
     * @method static \Xgenious\Paymentgateway\Base\Gateways\PayTabsPay paytabs()
     ...
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::setAccessToken
     * @method static void setAccessToken()
     ...
     * @see \Xgenious\Paymentgateway\Base\Gateways\InstamojoPay::supported_currency_list
     * @method static string[] supported_currency_list()
     * @see \Xgenious\Paymentgateway\Traits\PaymentEnvironment::setEnv
     * @method static \Xgenious\Paymentgateway\Traits\PaymentEnvironment setEnv($env)
     * @see \Xgenious\Paymentgateway\Base\Gateways\InstamojoPay::ipn_response
     * @method static array|string[] ipn_response(array $args = [])
     * @see \Xgenious\Paymentgateway\Base\Gateways\InstamojoPay::charge_customer
     * @method static \Illuminate\Http\RedirectResponse|void charge_customer(array $args)
     * @see \Xgenious\Paymentgateway\Traits\CurrencySupport::setExchangeRate
     * @method static \Xgenious\Paymentgateway\Traits\CurrencySupport setExchangeRate($rate)
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayBase::verified_data
     * @method static array verified_data($args)
     * @see \Xgenious\Paymentgateway\Base\Gateways\InstamojoPay::setClientId
     * @method static \Xgenious\Paymentgateway\Base\Gateways\InstamojoPay setClientId($client_id)
     * @see \Xgenious\Paymentgateway\Traits\CurrencySupport::getExchangeRate
     * @method static void getExchangeRate()
     * @see \Xgenious\Paymentgateway\Base\Gateways\InstamojoPay::setSecretKey
     * @method static \Xgenious\Paymentgateway\Base\Gateways\InstamojoPay setSecretKey($secret_key)
     * @see \Xgenious\Paymentgateway\Traits\CurrencySupport::setCurrency
     * @method static \Xgenious\Paymentgateway\Traits\CurrencySupport setCurrency($currency = "USD")
     * @see \Xgenious\Paymentgateway\Base\Gateways\InstamojoPay::gateway_name
     * @method static string gateway_name()
     * @see \Xgenious\Paymentgateway\Base\Gateways\InstamojoPay::charge_amount
     * @method static float|int|mixed|string charge_amount($amount)
     * @see \Xgenious\Paymentgateway\Base\Gateways\InstamojoPay::charge_currency
     * @method static string charge_currency()
     */
...
namespace {
    ...
    class Billplz extends Billplz\Laravel\Billplz {}
