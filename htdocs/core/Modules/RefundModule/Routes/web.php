...
Route::middleware([
    ...
    Route::controller(RefundModuleController::class)->middleware(['tenantUserMailVerify','package_expire', 'website_creation_in_progress'])->name('tenant.')->group(function(){
    ...
    Route::controller(RefundChatController::class)->middleware(['tenantUserMailVerify','package_expire', 'website_creation_in_progress'])->name('tenant.')->group(function (){
